        ...
        <div className='h-full'>
            ...
            >
                <Sidebar.Items>
                    ...
                    <Sidebar.ItemGroup className='flex flex-col gap-1'>
                        {currentUser && currentUser.isReception && (
                            <Link to='/reception-dashboard?tab=dashboard'>
                                <Sidebar.Item active={tab === 'dashboard' || !tab} icon={HiChartPie} label={'Reception'} labelColor={'red'} as='div'>Dashboard</Sidebar.Item>
                            </Link>
                        )}
                        {currentUser.isReception && (
                            <Link to='/reception-dashboard?tab=reservations'>
                                <Sidebar.Item active={tab === 'reservations'} icon={FaRegCalendarAlt} as='div'>Reservations</Sidebar.Item>
                            </Link>
                        )}
                    </Sidebar.ItemGroup>
                    <Sidebar.ItemGroup className='flex flex-col gap-1'>
